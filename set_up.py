...
def get_spec_formatted(device, sn):
    try:
        ...
        for i in range(1):
            ...
            print("spectra[100,200,300,400,500,1400]: %d, %d, %d, %d, %d, %d" % (
                spectra[100], spectra[200], spectra[300], spectra[400], spectra[500], spectra[1400]
            ), flush=True)
...
if __name__ == '__main__':
    ...
    if device_count == 0:
        ...
        for id in device_ids:
            ...
            get_spec_formatted(device, serial_number)
